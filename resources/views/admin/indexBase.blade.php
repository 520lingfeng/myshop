...
<html lang="en">
  <head>
    ...
    <![endif]-->
      <link rel="stylesheet" href="{{URL::asset(__ADMIN__.'assets/css/ace.min.css')}}" />
      <link rel="stylesheet" href="{{URL::asset(__ADMIN__.'assets/css/ace-rtl.min.css')}}" />
      <link rel="stylesheet" href="{{URL::asset(__ADMIN__.'assets/css/ace-skins.min.css')}}" />
    ...
    <![endif]-->
      <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/ace-extra.min.js')}}"></script>
    <!--[if lt IE 9]>
    ...
    <![endif]-->
    <!--[if !IE]> -->
      <script type="text/javascript" src="{{URL::asset(__ADMIN__.'js/jquery-1.9.1.min.js')}}"></script>
    <!-- <![endif]-->
    <!--[if IE]>
      <script type="text/javascript">
        window.jQuery ||
          document.write(
            "<script src={{URL::asset(__ADMIN__.'assets/js/jquery-1.10.2.min.js')}}>" + "<" + "script>"
          );
      </script>
    <![endif]-->
    <script type="text/javascript">
      if ("ontouchend" in document)
        document.write(
          "<script src={{URL::asset(__ADMIN__.'assets/js/jquery.mobile.custom.min.js')}}>" +
            "<" +
            "script>"
        );
    </script>
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/bootstrap.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/typeahead-bs2.min.js')}}"></script>
    <!--[if lte IE 8]>
      <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/excanvas.min.js')}}"></script>
    <![endif]-->
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/ace-elements.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/js/ace.min.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/layer/layer.js')}}"></script>
    <script type="text/javascript" src="{{URL::asset(__ADMIN__.'assets/laydate/laydate.js')}}"></script>
    ...
    <script type="text/javascript">
      ...
      jQuery(document).ready(function () {
        ...
        $(".iframeurl").click(function () {
          ...
          $(".Current_page")
            .html(cname)
            .css({ color: "#333333", cursor: "default" })
            .ready();
          $("#parentIframe")
  ...
  <body>
      ...
      <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
          <a href="#" class="navbar-brand">
            <small>
              <img src="{{URL::asset(__ADMIN__.'images/logo.png')}}" />
            </small> </a
          ><!-- /.brand -->
        </div>
        <!-- /.navbar-header -->
                  ...
                  <a href="#">
                    <div class="clearfix">
                      <span class="pull-left">
                        <i
                          class="btn btn-xs no-hover btn-pink icon-comment"
                        ></i>
                        新闻评论
                      </span>
                ...
                <li>
                  <a href="#">
                    <div class="clearfix">
                      <span class="pull-left">
                        <i
                          class="btn btn-xs no-hover btn-success icon-shopping-cart"
                        ></i>
                        新订单
                      </span>
                ...
                <li>
                  <a href="#">
                    <div class="clearfix">
                      <span class="pull-left">
                        <i
                          class="btn btn-xs no-hover btn-info icon-twitter"
                        ></i>
                        粉丝
                      </span>
            ...
            <li>
              ...
              <ul class="submenu">
                ...
                <li class="home">
                  <a
                    href="javascript:void(0)"
                    name="{:url('/adminAdvertisementSort')}"
                    title="分类管理"
                    class="iframeurl"
                    ><i class="icon-double-angle-right"></i>分类管理</a
                  >
            ...
            <li>
              ...
              <ul class="submenu">
                ...
                <li class="home">
                  <a
                    href="javascript:void(0)"
                    name="{:url('/adminArticleSort')}"
                    title="分类分类"
                    class="iframeurl"
                    ><i class="icon-double-angle-right"></i>分类分类</a
                  >
                </li>
              </ul>
            </li>
    ...
    <div class="footer_style" id="footerstyle">
      ...
      <p class="r_f">
        地址：南京市鼓楼区阅江楼街道公共路64号 邮编：210011 技术支持：XXXX
      </p>
    </div>
    <!--修改密码样式-->
